// Generated from C:/Users/ASUS/IdeaProjects/FlaskTemplateCompiler/src/antlr/ProductLexer.g4 by ANTLR 4.13.2
package antlr;
...
public class ProductLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FROM", "IMPORT", "FLASK", "FLASK_KW", "RENDER_STR", "REQUEST", "APP", 
			"DEF", "RETURN", "RUN", "DEBUG", "IF", "METHOD", "FORM", "INT", "METHODS", 
			"GET", "POST", "AT", "EQEQ", "EQ", "LP", "RP", "LBRACK", "RBRACK", "LBRACE", 
			"RBRACE", "COLON", "COMMA", "DOT", "STRING", "NUMBER", "TRIPLE_STRING", 
			"DUUNDER_NAME", "ID", "WS"
		};
	}
